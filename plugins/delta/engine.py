...
from core.ops.composite.delta import DeltaOps
...
def execute_logic(connection_manager, command_model: CommandModel, plugin_instance):
    ...
    registry_identifier, registry_file_path = DeltaOps.get_registry_info(source_object)
    ...
    if getattr(destination_object, "content_only", False) or not target_object_key or target_object_key.endswith("/"):
