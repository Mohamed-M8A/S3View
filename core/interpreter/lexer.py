# ==================================================================================
# SCRIPT LEXICAL ANALYZER (TOKENIZER)
# ------------------------------------------------------------------------------
# FUNCTIONALITY:
# 1. Lexical Scanning: Performs a linear, pointer-based scan of raw script text 
#    to identify atomic language components (Tokens).
# 2. Syntax Categorization: Maps text segments into distinct types: Keywords, 
#    Metadata, Block Markers, Strings, and Delimiters.
# 3. Context-Aware Grouping: Intelligently handles nested parentheses () and 
#    brackets [] to preserve metadata integrity during tokenization.
# 4. Error Localization: Tracks line and column coordinates to provide precise 
#    syntactic feedback in case of Unterminated Strings or Unmatched Groups.
# 5. Comment Handling: Automatically strips inline comments (//) to isolate 
#    executable logic without affecting token indices.
# ==================================================================================
