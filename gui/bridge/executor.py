...
class PipelineHandler:
    ...
    def execute(script_content, is_dry_run):
        try:
            ...
            commands_file_path = CoreUtils.resource_path("WORKSPACE/Commands.view")
    ...
    @staticmethod
    def open_reports():
        reports_directory_path = CoreUtils.resource_path("Reports")
    ...
    @staticmethod
    def show_latest():
        html_reports_directory = CoreUtils.resource_path("Reports/HTML")
